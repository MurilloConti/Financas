insert into fundos(ANBIMA,CNPJ,ISIN,Nome,TxAdministracao,TxImpRenda,TxPerformance,txResgate)
values('236942',11182064000177,'BRNPF2CTF001','Constância Fundamento FIA',2,15,20,0);
insert into fundos(ANBIMA,CNPJ,ISIN,Nome,TxAdministracao,TxImpRenda,TxPerformance,txResgate)
values('289140',13155995000101,'BRDAY2CTF007','Daycoval Ibovespa Ativo FIA',2.5,15,20,0);
insert into fundos(ANBIMA,CNPJ,ISIN,Nome,TxAdministracao,TxImpRenda,TxPerformance,txResgate)
values('431923',26142614000100,'BRDDB1CTF003','Daycoval Debêntures Incentiva FIM C Priv',0.75,0,0,0);
insert into fundos(ANBIMA,CNPJ,ISIN,Nome,TxAdministracao,TxImpRenda,TxPerformance,txResgate)
values('425524',24623412000146,'BRBSP3CTF008','	BP Debêntures Incentiv 45 FIC FIM C Priv',0,0,20,0);
